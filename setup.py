...
setup(
    ...
    description="Pysteps importer plugin for reading metranet files with py-radlib",
    ...
    keywords=["pysteps_importer_metranet", "pysteps", "plugin", "importer"],
    name="pysteps-importer-metranet",
    ...
    entry_points={
        "pysteps.plugins.importers": [
            "importer_mch_metranet_radlib=pysteps_importer_metranet.importer_mch_metranet_radlib:import_mch_metranet_radlib",
